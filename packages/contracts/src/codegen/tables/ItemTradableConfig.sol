...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ItemTradableConf")));
bytes32 constant ItemTradableConfigTableId = _tableId;

library ItemTradableConfig {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    return ("ItemTradableConfig", _fieldNames);
  }
  ...
  function encode(bool tradable) internal pure returns (bytes memory) {
