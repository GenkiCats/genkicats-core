...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("GlobalIDCount")));
bytes32 constant GlobalIDCountTableId = _tableId;

library GlobalIDCount {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "count";
    return ("GlobalIDCount", _fieldNames);
  }
  ...
  function get(IStore _store) internal view returns (uint256 count) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(IStore _store, uint256 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function encode(uint256 count) internal pure returns (bytes memory) {
