...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ItemBuffConfig")));
bytes32 constant ItemBuffConfigTableId = _tableId;

library ItemBuffConfig {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "buffIds";
    return ("ItemBuffConfig", _fieldNames);
  }
  ...
  /** Get buffIds */
  function get(bytes32 itemId) internal view returns (bytes32[] memory buffIds) {
  ...
  /** Get buffIds (using the specified store) */
  function get(IStore _store, bytes32 itemId) internal view returns (bytes32[] memory buffIds) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = itemId;
  ...
  /** Set buffIds */
  function set(bytes32 itemId, bytes32[] memory buffIds) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = itemId;

    StoreSwitch.setField(_tableId, _keyTuple, 0, EncodeArray.encode((buffIds)));
  }

  /** Set buffIds (using the specified store) */
  function set(IStore _store, bytes32 itemId, bytes32[] memory buffIds) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = itemId;

    _store.setField(_tableId, _keyTuple, 0, EncodeArray.encode((buffIds)));
  }

  /** Get the length of buffIds */
  ...
  /** Get the length of buffIds (using the specified store) */
  ...
  /** Get an item of buffIds (unchecked, returns invalid data if index overflows) */
  ...
  /** Get an item of buffIds (using the specified store) (unchecked, returns invalid data if index overflows) */
  ...
  /** Push an element to buffIds (using the specified store) */
  ...
  /** Pop an element from buffIds (using the specified store) */
  ...
  /** Update an element of buffIds at `_index` */
  ...
  /** Update an element of buffIds (using the specified store) at `_index` */
  ...
  function encode(bytes32[] memory buffIds) internal pure returns (bytes memory) {
    uint40[] memory _counters = new uint40[](1);
    _counters[0] = uint40(buffIds.length * 32);
    PackedCounter _encodedLengths = PackedCounterLib.pack(_counters);

    return abi.encodePacked(_encodedLengths.unwrap(), EncodeArray.encode((buffIds)));
  }
